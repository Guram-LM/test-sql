...
export default function TermsOfUse() {
  ...
  return (
    <>
      <Helmet>
        <title>გამოყენების პირობები | ნუცა ბახტაძე</title>
        <meta
          name="description"
          content="ნუცა ბახტაძეს ვებგვერდის გამოყენების პირობები — უფლებები, ვალდებულებები და წესები საიტის გამოყენებისას."
        />
        <link rel="canonical" href="https://nutsabakhtadze.com/terms-of-use/" />
      </Helmet>
        ...
        <div className="max-w-3xl mx-auto w-full px-4 md:px-6 pt-16 md:pt-20 pb-10 space-y-12 animate-fade-in">
          ...
          <section className="space-y-5">
            <h2 className="text-xl md:text-2xl font-semibold text-[#D4AF37]">
              {t("use.intellectualTitle")}
            </h2>
            <p className="text-base md:text-lg text-gray-700 leading-relaxed">
              {t("use.intellectualText")}
            </p>
          </section>
          <section className="space-y-5">
            <h2 className="text-xl md:text-2xl font-semibold text-[#D4AF37]">
          ...
          <p className="text-center text-gray-500 text-sm md:text-base pt-16 pb-8">
            {t("use.updated")}: {new Date().toLocaleDateString("ka-GE")}
          </p>
        </div>
